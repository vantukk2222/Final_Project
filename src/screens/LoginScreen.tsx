  ...
  return (
    <ScrollView style={styles.container}>
      ...
      > */}
        {/* Banner du lịch */}
        <Image
          source={{uri:'https://images.unsplash.com/photo-1503220317375-aaad61436b1b?ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80'}}
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputContainer}>
              <Icon name="envelope-open-text" size={18} color="#666" style={styles.inputIcon} />
              <Controller
                control={control}
                name="email"
                rules={{
